...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Soportar mensajes de error de validación múltiples del backend
          ...
          <CardContent>
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <Input
                ...
                onChange={handleChange}
                required
                placeholder="Mínimo 6 caracteres, 1 mayúscula, 1 minúscula, 1 caracter especial"
                helpText="Debe tener al menos 6 caracteres, una mayúscula, una minúscula y un caracter especial"
              />
